...
1	Walter	walter es muy pesaito	\N	\N
...
SELECT pg_catalog.setval('public.migrate_01_asignatura_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.migrate_01_departamento_id_seq', 4, true);
